...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-parallellogger-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14368&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-parallellogger-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-parallellogger` can be installed with:

```
conda install r-parallellogger
```

It is possible to list all of the versions of `r-parallellogger` available on your platform with:
